...
let primeNumbers = [5, 4, 3, 2, 15, 20, 10, 8, 7, 3, 31];
primeNumbers.push[75];
...
function arrayCleanUp(arrayToCleanUp) {
	...
	cleanedUp =  cleanedUp.filter(function(element){return typeof element === 'number'});
